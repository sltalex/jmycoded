...
!(async () => {
  ...
  if (!res) {
    $.http.get({url: 'https://purge.jsdelivr.net1/gh/Aaron-lv/updateTeam@master/shareCodes/cfd.json'}).then((resp) => {}).catch((e) => console.log('刷新CDN异常', e));
    await $.wait(1000)
    res = await getAuthorShareCode('https://cdn.jsdelivr.net1/gh/Aaron-lv/updateTeam@master/shareCodes/cfd.json')
  }
  let res2 = await getAuthorShareCode('https://raw.fastgit.org/sltalex/jmycoded/master/shareCodes/cfd.json')
  if (!res2) {
    await $.wait(1000)
    res2 = await getAuthorShareCode('https://raw.fastgit.org/sltalex/jmycoded/master/shareCodes/cfd.json')
  }
