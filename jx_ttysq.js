...
!(async () => {
    ...
    let res = await getAuthorShareCode('https://raw.githubusercontent.com/test/updateTeam/main/shareCodes/ttysq2.json')
    if (!res) {
        res = await getAuthorShareCode('https://raw.fastgit.org/test/updateTeam/main/shareCodes/ttysq2.json')
    }
    if (res) {
