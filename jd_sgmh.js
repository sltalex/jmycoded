...
更新地址：https://raw.githubusercontent.com/testv/sync/jd_scripts/jd_sgmh.js
已支持IOS双京东账号, Node.js支持N个京东账号
脚本兼容: QuantumultX, Surge, Loon, 小火箭，JSBox, Node.js
============Quantumultx===============
[task_local]
#闪购盲盒
20 8 * * * https://raw.githubusercontent.com/testv/sync/jd_scripts/jd_sgmh.js, tag=闪购盲盒, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
================Loon==============
[Script]
cron "20 8 * * *" script-path=https://raw.githubusercontent.com/testv/sync/jd_scripts/jd_sgmh.js, tag=闪购盲盒
===============Surge=================
闪购盲盒 = type=cron,cronexp="20 8 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/testv/sync/jd_scripts/jd_sgmh.js
============小火箭=========
闪购盲盒 = type=cron,script-path=https://raw.githubusercontent.com/testv/sync/jd_scripts/jd_sgmh.js, cronexpr="20 8 * * *", timeout=3600, enable=true
 */
const $ = new Env('闪购盲盒');
...
function readShareCode() {
  console.log(`开始`)
  return new Promise(async resolve => {
    $.get({url: `http://test.nz.lu/sgmh`, timeout: 10000}, (err, resp, data) => {
      try {
        if (err) {
