...
京东金融养猪猪
活动入口：京东金融养猪猪，
脚本更新地址：https://github.com/test/JD_tencent_scf
...
[task_local]
京东金融养猪猪
12 0-23/6 * * * https://raw.githubusercontent.com/test/JD_tencent_scf/main/jd_pigPet.js, tag=京东金融养猪猪, enabled=true
================Loon==============
[Script]
cron "12 0-23/6 * * *" script-path=https://raw.githubusercontent.com/test/JD_tencent_scf/main/jd_pigPet.js,tag=摇钱树助力
===============Surge=================
京东金融养猪猪 = type=cron,cronexp="12 0-23/6 * * *",wake-system=1,timeout=20,script-path=https://raw.githubusercontent.com/test/JD_tencent_scf/main/jd_pigPet.js
============小火箭=========
京东金融养猪猪 = type=cron,script-path=https://raw.githubusercontent.com/test/JD_tencent_scf/main/jd_pigPet.js, cronexpr="12 0-23/6 * * *", timeout=3600, enable=true
*
*/
const $ = new Env('金融养猪');
              ...
              if (data.resultData.resultCode === 0 && n < 5) {
                ...
                for (let i = 0; i < $.friends.length; i++) {
                  if ($.friends[i].status === 1) {
                    ...
                    if (!['test', 'xfa05'].includes($.name)) { //放过孩子吧TT
...
function getShareCode() {
  return new Promise(resolve => {
    $.get({
      url: "https://raw.test.org/test/updateTeam/main/shareCodes/pig.json",
      headers: {
