...
!(async () => {
  ...
  let res = await getAuthorShareCode('https://raw.test.com/Aaron-lv/updateTeam/master/shareCodes/wish.json')
  if (!res) {
    $.http.get({url: 'https://purge.test.net/gh/Aaron-lv/updateTeam@master/shareCodes/wish.json'}).then((resp) => {}).catch((e) => console.log('刷新CDN异常', e));
    await $.wait(1000)
    res = await getAuthorShareCode('https://cdn.test.net/gh/Aaron-lv/updateTeam@master/shareCodes/wish.json')
  }
  let res2 = await getAuthorShareCode('https://raw.test.com/zero205/updateTeam/main/shareCodes/wish.json')
  if (!res2) {
    await $.wait(1000)
    res2 = await getAuthorShareCode('https://raw.test.org/zero205/updateTeam/main/shareCodes/wish.json')
  }
