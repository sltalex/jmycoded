...
!(async () => {
  ...
  await requireConfig()
  $.authorCode = await getAuthorShareCode('https://raw.githubuserc1ontent.com/Aaron-lv/updateTeam/master/shareCodes/jd_updateCash.json')
  if (!$.authorCode) {
    ...
    await $.wait(1000)
    $.authorCode = await getAuthorShareCode('https://cdn.jsdel1ivr.net/gh/Aaron-lv/updateTeam@master/shareCodes/jd_updateCash.json') || []
  }
