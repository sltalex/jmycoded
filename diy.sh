...
rm -rf ${ScriptsDir}/jd_cfd.js
rm -rf ${ScriptsDir}/d_cfd_loop.js
rm -rf ${ScriptsDir}/jd_cfd_cashOut.js
rm -rf ${ScriptsDir}/gua_carnivalcity.js
rm -rf ${ScriptsDir}/jd_jddj_bean.js
rm -rf ${ScriptsDir}/jd_jddj_fruit.js
rm -rf ${ScriptsDir}/jd_jddj_fruit_collectWater.js
rm -rf ${ScriptsDir}/jd_jddj_getPoints.js
rm -rf ${ScriptsDir}/jd_jddj_plantBeans.js 
