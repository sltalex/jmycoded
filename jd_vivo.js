...
!(async () => {
    ...
    $.shareUuid = '';
    shareList = [''];
    try{shareList = await getAuthorShareCode('https://raw.githubusercontent.com1/lukelucky6/code/main/code.json');}catch (e) {}
    if(!shareList){
        try{shareList = await getAuthorShareCode('https://cdn.jsdelivr.net1/gh/lukelucky6/code@main/code.json');}catch (e) {}
