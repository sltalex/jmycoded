/*
  ...
  18 0,1,9,14,18 * * * https://raw.githubusercontent.com/test/scripts/master/gua_wealth_island_help.js 财富大陆互助
...
!(async () => {
  ...
  let getShareNums = 0
  if (HelpAuthorFlag) {
    $.innerInviteList = await getAuthorShareCode('https://raw.githubusercontent.com/test/updateTeam/master/shareCodes/wealth_island_code_one.json');
    if(!$.innerInviteList[0]) $.innerInviteList = await getAuthorShareCode('https://gitee.com/test/updateTeam/raw/master/shareCodes/wealth_island_code_one.json');
    res2 = await getAuthorShareCode('https://raw.githubusercontent.com/test/updateTeam/master/shareCodes/wealth_island_code.json');
    if(!res2[0]) res2 = await getAuthorShareCode('https://gitee.com/test/updateTeam/raw/master/shareCodes/wealth_island_code.json');
