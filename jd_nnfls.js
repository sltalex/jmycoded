...
!(async () => {
    ...
    const author = Math.random() > 0.5 ? 'test' : 'ZXX2021'
...
function getShareCode(name, author = 'test', num = -1, shuffle = false) {
    return new Promise(resolve => {
        $.get({
            url: `https://raw.test.org/${author}/updateTeam/main/shareCodes/${name}`,
            headers: {
