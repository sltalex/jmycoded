...
脚本会默认帮test助力开工位，如需关闭请添加变量，变量名：HELP_JOYPARK，变量值：false
...
function getShareCode() {
  return new Promise(resolve => {
      $.get({
          url: "https://raw.test.org/test/updateTeam/main/shareCodes/joypark.json",
          headers: {
