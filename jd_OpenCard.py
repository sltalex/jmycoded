...
class getJDCookie(object):
    ...
    def getckfile(self):
        ...
        elif os.path.exists('/root/jd/config/cookie.sh'):
            print("当前环境A1")
            return '/root/jd/config/cookie.sh'
        return '获取不到配置文件'
    ...
    def iscookie(self):
        ...
        if 'pt_key=' in cookies and 'pt_pin=' in cookies:
            ...
            if len(result) >= 1:
                ...
                print("cookie 格式错误！...本次操作已退出1")
                exit(4)
        else:
            print("cookie 格式错误！...本次操作已退出2")
            exit(4)
getCk = getJDCookie()
getCk.getCookie()
...
def start():
    ...
    print("获取账号...")
    cookies, userNames, pinNameList = getCk.iscookie()
